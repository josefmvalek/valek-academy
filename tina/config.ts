              ...
              },
              {
                ...
                fields: [
                  ...
                  { type: "string", name: "note", label: "Poznámka pod kalkulátorem", ui: { component: "textarea" } },
                  {
                    ...
                    list: true,
                    ui: { itemProps: (item) => ({ label: `${item?.label || "Období"} (${item?.weeks || 0} týdnů – sleva ${item?.baseDiscount ?? 0} %)` }) },
                    fields: [
                  ...
                  },
                  {
                    ...
                    list: true,
                    ui: { itemProps: (item) => ({ label: `${item?.label || "Frekvence"} (${item?.freq || 1}× týdně – bonus +${item?.bonus ?? 0} %)` }) },
                    fields: [
