        ...
        fields: [
            ...
            fields: [
              ...
              },
              {
                ...
                fields: [
                  ...
                  { type: "string", name: "timeNote", label: "Poznámka k času (např. Individuální tempo)" },
                  { type: "string", name: "icon", label: "Ikona / Emoji" },
                  { type: "string", name: "title", label: "Nadpis bloku" },
                  { type: "string", name: "subtitle", label: "Podtitul" },
                  { type: "string", name: "desc", label: "Popis bloku", ui: { component: "textarea" } },
            ...
            fields: [
              ...
              },
              {
                ...
                fields: [
                  ...
                  { type: "number", name: "basePrice", label: "Základní cena za lekci v Kč (např. 320)" },
                  ...
                  { type: "string", name: "note", label: "Poznámka pod kalkulátorem", ui: { component: "textarea" } },
                  {
                    ...
                    list: true,
                    ui: { itemProps: (item) => ({ label: `${item?.label || "Období"} (${item?.weeks || 0} týdnů)` }) },
                    fields: [
                      ...
                      { type: "string", name: "badge", label: "Štítek slevy (např. -15 %)" },
                      { type: "number", name: "baseDiscount", label: "Sleva v % (např. 15)" },
                  ...
                  },
                  {
                    ...
                    list: true,
                    ui: { itemProps: (item) => ({ label: `${item?.label || "Frekvence"} (${item?.freq || 1}x týdně)` }) },
                    fields: [
                      ...
                      { type: "number", name: "bonus", label: "Bonusová sleva v % (např. 5)" },
                      { type: "string", name: "badge", label: "Štítek bonusu (např. +5 % extra sleva)" },
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "tooltipText", label: "Text bubliny při najetí (např. Napsat Josefovi na WhatsApp →)" },
